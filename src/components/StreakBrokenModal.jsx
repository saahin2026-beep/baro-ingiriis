  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, zIndex: 1000 }}>
      <div style={{ background: 'white', borderRadius: 24, padding: 32, maxWidth: 340, width: '100%', textAlign: 'center', position: 'relative' }}>
        ...
        <h2 style={{ fontSize: 22, fontWeight: 800, color: '#EF4444', fontFamily: 'Nunito, sans-serif', margin: '0 0 8px' }}>Streak-kaagii wuu jabay</h2>
        {lostStreak > 0 && (
        ...
        <button onClick={onStartLesson} style={{ width: '100%', padding: '16px 24px', background: '#10B981', color: 'white', border: 'none', borderRadius: 14, fontSize: 16, fontWeight: 700, fontFamily: 'Nunito, sans-serif', cursor: 'pointer', marginBottom: 10 }}>
          Casharka maanta bilow
        </button>
        <button onClick={onBuyFreeze} style={{ width: '100%', padding: '14px 24px', background: '#E0F2FE', color: '#0891B2', border: 'none', borderRadius: 14, fontSize: 14, fontWeight: 700, fontFamily: 'Nunito, sans-serif', cursor: 'pointer' }}>
